...
suite "skia basic types":
  ...
  test "image info methods do not modify source":
    let info = newSkImageInfo(100, 30, Rgb565, Unpremul, nil)
  ...
  test "rectangle has correct properties":
    let rect = newSkRect(15.0 , 25.0, 55.0, 75.0)
  ...
  test "rectangle offsets correctly":
    let expected = newSkRect(25.0, 30.0, 65.0, 80.0)

    let rect1 = newSkRect(15.0 , 25.0, 55.0, 75.0)
    rect1.location = newSkPoint(25.0, 30.0)

    var rect2 = newSkRect(15.0 , 25.0, 55.0, 75.0)
    rect2.offset(10, 5)
